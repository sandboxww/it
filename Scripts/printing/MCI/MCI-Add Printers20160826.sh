...
#Add MCI Printers
lpadmin -E -p "MCIKyocera4551" -v "lpd://10.1.8.45/MCI-CS 4551Color" -D "MCI-Kyocera4551" -L "MCI - 920 Main St KCMO" -P "/Library/Printers/PPDs/Contents/Resources/Kyocera CS 4551ci.PPD" -o printer-is-shared=false -E -o HardDisk=True
